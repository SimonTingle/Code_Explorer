...
class ExplorerUI(ttk.Frame):
    ...
    def open_audit_blueprint_manager(self):
        """
        REASON: GRID LAYOUT & MENU FAILSAFE.
        Switched from .pack() to .grid() to force buttons to appear.
        Added a dedicated Menu Bar to the window as a backup.
        """
        # 1. Window Setup
        ...
        # Configure Grid Weights (Row 0 expands, Row 1 is fixed)
        win.columnconfigure(0, weight=1)
        win.rowconfigure(0, weight=1) # The List takes all space
        win.rowconfigure(1, weight=0) # The Buttons take fixed space

        # ---------------------------------------------------------
        # FAILSAFE: WINDOW MENU BAR
        # ---------------------------------------------------------
        # Even if buttons are invisible, this menu at the top of the window will work.
        menubar = tk.Menu(win)
        ...
        # Add Edit command to the top menu
        ...
        # ---------------------------------------------------------
        # ROW 1: THE BUTTONS (The "Rocks")
        # ---------------------------------------------------------
        # Using Grid Row 1 ensures this is ALWAYS at the bottom.
